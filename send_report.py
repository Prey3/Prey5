...
class DingRobot:
    def __init__(self):
        ...
        self.allure = "http://admin:123456@101.200.243.163:9000/job/Prey9/39/allure/widgets/suites.json"
        ...
        if self.error >= 0:
            ...
            content = {
                ...
                "link": {
                    ...
                    "picUrl": "",
                    "messageUrl": "http://admin:123456@101.200.243.163:9000/job/Prey9/39/allure/"
                }
            }
